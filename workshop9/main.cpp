...
// In the main.cpp section, I modified listArrayElements("All the cars:", C,7) in line 36, listArrayElements("All students:", S, 6) in line 52, listArrayElements("All employees:", E, 6) in line 68, listArrayElements("INTEGERS", a, 6) in line 101 to call template function void listArrayElements(const char*listTitle, T& array, int noOfElement) in searchNlist.h file.
// I also modified search(Cres,C,7,"Tesla") in line 41, search(Sres, S, 6, 4.0) in line 57, search(Eres, E, 6,111) in line 74 and search(Eres, E, 6,555) in line 88 to call template function bool search(Collection<T1> & obj, T1 *array,int noOfElement,T2 key) in searchNlist.h file.
///////////////////////////////////////////////////
#include <iostream>
#include "Car.h"
#include "Employee.h"
